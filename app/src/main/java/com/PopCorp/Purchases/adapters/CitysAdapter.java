...
public class CitysAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public CitysAdapter(Context context, ArrayList<City> array) {
        ...
        final TypedArray ta = context.getResources().obtainTypedArray(R.array.colors_for_citys);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (selectedCity != null && city.equals(selectedCity)) {
            view.setBackgroundResource(R.drawable.list_selector_foreground);
        ...
        TextView region = (TextView) view.findViewById(R.id.city_region);
