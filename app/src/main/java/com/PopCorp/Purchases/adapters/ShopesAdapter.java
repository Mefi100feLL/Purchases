...
public class ShopesAdapter extends RecyclerView.Adapter<ShopesAdapter.ViewHolder> implements Filterable {
    ...
    public ShopesAdapter(Context context, ShopFavoriteCallback callback, ArrayList<Shop> objects) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View view) {
            ...
            count = (TextView) view.findViewById(R.id.shop_sales_count);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.count.setText(context.getString(R.string.count_of_sales) + " " + shop.getCountSales());
